 ...
 const Hireme = () => {
  ...
  <div className="font-sans flex flex-col lg:flex-row px-4 md:px-12 lg:px-24 xl:px-[200px]">
    <div className="pl-2 md:pl-6 lg:pl-9 pt-7 my-10 md:my-16 lg:my-20 w-full text-center lg:text-left flex flex-col justify-start items-center lg:items-start">
      <h2 className="text-[28px] md:text-[32px] lg:text-[35px] font-bold text-green-600">Hello,</h2>
      ...
      <button
        onClick={Hireme}
        className="mt-6 px-6 py-2 text-[18px] md:text-[20px] text-white bg-green-500 font-semibold rounded-md shadow hover:bg-green-400 active:scale-95"
      >
        Hire Me
      </button>
      <div className="flex gap-3 mt-10 md:mt-16 lg:mt-[80px] ml-0 lg:ml-3">
        <a href="https://www.linkedin.com/in/virendra-rao-581b37364/" target="_blank" className="text-blue-500 hover:text-blue-600" >
    ...
    <div className="w-full h-full flex justify-center items-center mt-8 lg:mt-0">
      <div className="h-[250px] w-[180px]  md:h-[320px] md:w-[240px] lg:h-[400px] lg:w-[300px] my-6 md:my-12 lg:my-20 overflow-hidden border-[3px] rounded-tl-[40px] md:rounded-tl-[60px] lg:rounded-tl-[80px] rounded-tr-lg rounded-bl-xl drop-shadow-[0_35px_35px_rgba(30,180,94,1)] rounded-br-[30px] md:rounded-br-[40px] lg:rounded-br-[50px] bg-green-900 duration-300 transition">
